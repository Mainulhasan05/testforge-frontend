          ...
          <DialogContent>
            <form onSubmit={handleCreate}>
              <DialogHeader>
                ...
                <DialogDescription>Add a new feature to test in this session</DialogDescription>
              </DialogHeader>
      ...
      {status === "succeeded" && list.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-sm text-muted-foreground mb-4">Add features to start testing</p>
