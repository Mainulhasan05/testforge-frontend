...
export default function SessionsList({ orgId }) {
  ...
  useEffect(() => {
    if (orgId) {
      dispatch(fetchSessions({ orgId, params: { page, limit: 10, status: statusFilter } }))
    }
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      setFormData({ title: "", description: "", status: "active", startDate: "", endDate: "" })
          ...
          <DialogContent className="max-w-2xl">
            <form onSubmit={handleCreate}>
              <DialogHeader>
                ...
                <DialogDescription>Add a new test session to track features and test cases</DialogDescription>
              </DialogHeader>
      ...
      {status === "succeeded" && list.length === 0 && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-sm text-muted-foreground mb-4">Create your first test session to get started</p>
                  ...
                  <CardHeader>
                    ...
                    <div className="flex items-center gap-4 text-sm text-muted-foreground mt-2">
                      <div className="flex items-center gap-1">
                        ...
                        <span>
                          {session.startDate ? formatLocalDate(session.startDate) : "No start date"} -{" "}
                          {session.endDate ? formatLocalDate(session.endDate) : "No end date"}
                        </span>
                      </div>
                    </div>
                  </CardHeader>
